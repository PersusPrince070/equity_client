          ...
          <div className="mt-3.5 box box--stacked">
            <div className="overflow-auto xl:overflow-visible">
              <Table>
                <Table.Thead>
                  <Table.Tr>
                    <Table.Td className="font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] py-5 border-slate-200/80 text-slate-500">
                      Date
                    </Table.Td>
                    <Table.Td className="w-56 font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] py-5 border-slate-200/80 text-slate-500">
                      Menu Items Sold
                    </Table.Td>
                    <Table.Td className="truncate font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] py-5 border-slate-200/80 text-slate-500">
                      Customer Feedback
                    </Table.Td>
                    <Table.Td className="w-32 truncate text-right font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] py-5 border-slate-200/80 text-slate-500">
                      Total Sales
                    </Table.Td>
                    <Table.Td className="w-32 font-medium bg-slate-50 first:rounded-tl-[0.6rem] last:rounded-tr-[0.6rem] py-5 text-center border-slate-200/80 text-slate-500">
                      Action
                    </Table.Td>
                  </Table.Tr>
                </Table.Thead>
