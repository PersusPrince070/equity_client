  ...
  return (
    <div
      className={clsx([
        ...
        "before:content-[''] before:w-screen before:h-screen [&.background--hidden]:before:from-slate-200 [&.background--hidden]:before:to-transparent before:bg-gradient-to-b before:from-theme-1 before:to-theme-2 before:absolute before:z-[-1] before:transition-colors before:ease-in-out before:duration-300",
    ...
    >
      <div className="container fixed inset-x-0 z-50 mx-auto">
        ...
        >
          <a className="relative flex items-center mr-14" href="">
      ...
      <div className="container relative z-10 pt-40">
        <div className="flex flex-col items-center gap-56 mb-40">
          <div className="flex flex-col items-center">
            ...
            <div className="grid w-full grid-cols-3 gap-5 px-20 mt-36">
          ...
          >
            <div
              className={clsx([
                ...
                "before:content-[''] before:bg-gradient-to-b before:from-transparent before:via-white/80 before:to-white before:inset-0 before:absolute before:h-[360%] before:w-[150%] before:-mt-[4.5rem] before:-ml-[25%]",
              ])}
            >
            ...
            <div className="grid w-full grid-cols-3 px-20 mt-10 gap-x-6 gap-y-9">
          ...
          <div className="flex flex-col items-center w-full" id="pages-layouts">
            <div
              className={clsx([
                "text-3xl font-medium relative",
                "before:content-[''] before:bg-gradient-to-b before:from-transparent before:via-white/80 before:to-white before:inset-0 before:absolute before:h-[360%] before:w-[150%] before:-mt-[4.5rem] before:-ml-[25%]",
          ...
          <div className="flex flex-col items-center w-full" id="frameworks">
            ...
            <div className="grid w-full grid-cols-3 px-20 mt-10 gap-x-5 gap-y-8">
              <div className="flex flex-col items-center p-5 box box--stacked">
                ...
                <div className="mt-4 text-base font-medium">React 18+</div>
                <div className="pb-2 mt-2 leading-relaxed text-center text-slate-500">
                  React 18+ brings the latest advancements to the React library,
                  offering improved features and optimizations to empower your
              ...
              <div className="flex flex-col items-center p-5 box box--stacked">
                ...
                <div className="mt-4 text-base font-medium">TailwindCSS 3</div>
                <div className="pb-2 mt-2 leading-relaxed text-center text-slate-500">
              ...
              <div className="flex flex-col items-center p-5 box box--stacked">
                ...
                <div className="mt-4 text-base font-medium">Headless UI</div>
                <div className="pb-2 mt-2 leading-relaxed text-center text-slate-500">
                  Headless UI is a set of completely unstyled, fully accessible
                  UI components, designed to integrate seamlessly with your
                  design system or style. It allows you to build fully
                  customized UI.
                </div>
              </div>
              <div className="flex flex-col items-center p-5 box box--stacked">
                ...
                <div className="mt-4 text-base font-medium">Redux Toolkit</div>
                <div className="pb-2 mt-2 leading-relaxed text-center text-slate-500">
                  Redux Toolkit is the official, opinionated, batteries-included
                  toolset for efficient Redux development. It simplifies the
                  Redux workflow for managing your application's state.
                </div>
              </div>
              <div className="flex flex-col items-center p-5 box box--stacked">
                <div className="w-12 h-12">
                ...
                <div className="mt-4 text-base font-medium">Typescript</div>
                <div className="pb-2 mt-2 leading-relaxed text-center text-slate-500">
                  TypeScript is a superset of JavaScript that provides static
                  typing, enabling developers to catch errors and bugs in their
          ...
          <div className="w-full px-20 -mt-24">
            <div className="p-1 box box--stacked">
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-3/4 h-[120%] -rotate-[9deg] -mt-10 rounded-[0.6rem] overflow-hidden box p-1 -mr-[23%]">
                  <img
              ...
              <div className="flex w-full box box--stacked">
                ...
                <div className="flex flex-col flex-none p-5 border-l border-dashed w-72">
                  <div className="flex flex-col items-center gap-4 pt-3 pb-6 border-b border-dashed">
                    ...
                    <div className="text-base font-medium">Regular License</div>
                  </div>
