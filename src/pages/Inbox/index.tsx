        ...
        <div className="gap-5 flex flex-col sm:flex-row mt-3.5">
          ...
          <div className="w-full pb-10 overflow-hidden">
            <div className="flex flex-col w-full box box--stacked">
              ...
              <div className="px-5 mt-0.5">
                <div className="flex items-center px-5 py-3.5 border shadow-sm border-slate-200/70 rounded-[0.6rem] bg-primary/[0.01] mb-2">
                  <div className="flex items-center">
                    ...
                    <Lucide
                      icon="ChevronDown"
                      className="stroke-[1.2] w-5 h-5 ml-1 mr-0.5 text-slate-500/80"
                    />
                  </div>
                  ...
                  <div className="hidden ml-auto sm:block text-slate-500/70">
                    1 - 50 of 5,238
                  </div>
                    ...
                    {_.take(mails.fakeMails(), 13).map((faker, fakerKey) => (
                      ...
                      >
                        <div className="flex items-center px-5 py-3.5">
                          ...
                          <div className="pl-10 ml-auto text-xs whitespace-nowrap text-slate-500/70">
                            {faker.date}
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex flex-col items-center p-5 text-center sm:flex-row sm:text-left text-slate-500/80">
