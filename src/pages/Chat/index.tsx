                ...
                <div className="flex flex-col gap-3.5 py-5 px-3">
                  {_.take(messages.fakeMessages(), 9).map((faker, fakerKey) => (
                    ...
                    >
                      ...
                      <div className="border px-4 pt-3 pb-4 rounded-r-xl rounded-tl-xl bg-slate-50/80 group-[.right]:text-right group-[.right]:rounded-l-xl group-[.right]:rounded-br-none border-slate-200/80">
