  ...
  return (
    <>
      ...
      <div className="overflow-auto xl:overflow-visible">
        <Table className="border-b border-slate-200/60 cursor-pointer" hover={true}>
          <Table.Thead>
            <Table.Tr>
            ...
            {list.map(
              (listItem, itemKey) => (
                <Table.Tr
                  ...
                  onClick={() => navigate(`/campaign/${listItem.id}`)}
                >
                  ...
                  <Table.Td className="py-4 border-dashed dark:bg-darkmode-600">
                    ...
                    >
                      <Progress className="h-7 relative">
                        <Progress.Bar className="w-0" role="progressbar" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100}>
                        </Progress.Bar>
